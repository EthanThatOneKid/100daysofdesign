    ...
    <div class="wrap" id="gap">
      ...
      <div class="right-frame">
        ...
        <main>
          ...
          <h2>
            Welcome to LCARS <span class="go-tomato">Ultra</span> &#149; Classic
            Theme
          </h2>
          ...
          <footer>
            <div class="footer-inside">
              <div class="footer-text">
                <p>
                  <!-- Your copyright information is only a suggestion. You can also choose to delete this paragraph. -->
                  Content Copyright &#169; 2023 *replace this text with your site's
                  name or url*
                </p>
